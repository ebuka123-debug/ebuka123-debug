        ...
        <div class="my-container">
            <div class="row d-flex justify-content-center  w-100 g-0">
                <div class="col-11 col-lg-3 border rounded-3 p-4">
                    ...
                    <form action="/changepassword/updatePassword" method="post">
                        ...
                        <input class="form-control mb-3" type="text" placeholder="Email" name="email" aria-label="default input example">

                        <label class="mb-2">Enter new password</label>
                        <input class="form-control mb-4" type="password" placeholder="Password" name="user-password" aria-label="default input example">
                        <input type="submit" value="Change Password" name="login" class="w-100 btn mb-3 text-white" id="color">
