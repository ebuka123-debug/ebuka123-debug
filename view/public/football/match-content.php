...
<head>
    ...
    <link rel="stylesheet" href="/view/css/match-content.css">
...
<body>
    ...
    <div class="container pt-5">
        ...
        <div class="row border border-top-0 border-start-0 border-end-0 border-bottom-1">
            <div class="col">
                <ul class="nav my-nav justify-content-md-evenly mt-3">
                    <li class="nav-item">
                      <a class="nav-link active text-danger border-bottom border-5 border-danger" aria-current="page" href="/football/matches/match-content">Info</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row mt-4">
            <div class="col border d-flex align-items-center rounded pt-2 pb-2">
                <i class="fa fa-calendar-alt text-secondary" style="font-size: 19px;"></i>
                <div class="d-flex flex-column ps-3">
                    <span><b class="text-secondary">7 August 2022</b></span>
        ...
        <div class="row mt-4">
            <div class="col border d-flex align-items-center rounded pt-2 pb-2">
                <i class="fa fa-volume-up text-secondary" style="font-size: 19px;"></i>
                <div class="d-flex flex-column ps-3">
                    <span><b class="text-secondary">Jarred Gillett (Australia)</b></span>
                    <span class="text-secondary">Referee</span>
                </div>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col border d-flex align-items-center rounded pt-2 pb-2">
                <i class="fa fa-kaaba text-secondary" style="font-size: 19px;"></i>
                <div class="d-flex flex-column ps-3">
                    <span><b class="text-secondary">King power stadium</b></span>
        ...
        <div class="row mt-4 mb-5">
            <div class="col border d-flex align-items-center rounded pt-2 pb-2">
                <i class="fa fa-users text-secondary" style="font-size: 19px;"></i>
                <div class="d-flex flex-column ps-3">
                    <span><b class="text-secondary">31,794</b></span>
