...
<body>
    ...
    <ul class="nav d-none d-md-flex justify-content-center border-bottom border-2 pt-1  pb-1bg-light ">
        ...
        <li class="nav-item bottom-border me-md-4">
          <a class="nav-link  text-danger" href="<?=RouteUri("news","laliga")?>">La liga</a>
        </li>
        <li class="nav-item  on-hover  me-md-4">
    ...
    <div class="container-fluid d-md-none border-bottom mt-2">
        <div class="phone-nav">
            ...
            <a href="<?=RouteUri("news","premierLeague")?>" class="d-flex me-3 justify-content-center align-items-center text-secondary min-width">
                Premier league
            </a>
            <a href="<?=RouteUri("news","laliga")?>" class="d-flex me-3 justify-content-center align-items-center on-hover text-danger bottom-border min-width">
                La liga
            </a>
    ...
    <div class="container p-md-4 mt-md-4 mb-5">
        <div class="row mb-md-3 row-cols-1 row-cols-lg-2">
            <?php foreach($news as $row => $news_content):?>
                <?php if(trim($news_content['news_category']) == "laliga") :?>
                    <?php if($row % 2 == 0):?>
