...
$trendingNews=$newsModel->trendingNews();
...
<body>
    ...
    <ul class="nav d-none d-md-flex justify-content-center border-bottom border-2 pt-1  pb-1bg-light ">
        <li class="nav-item bottom-border me-md-4">
          <a class="nav-link  text-danger" href="<?=RouteUri("news","all")?>">All</a>
        </li>
        <li class="nav-item  on-hover  me-md-4">
          <a class="nav-link  text-secondary" href="<?=RouteUri("news","premierLeague")?>">Premier league</a>
        </li>
        <li class="nav-item  on-hover  me-md-4">
        ...
        <li class="nav-item  on-hover  me-md-4">
            <a class="nav-link  text-secondary" <?=RouteUri("news","others")?>>Others</a>
        </li>
    </ul>

    <div class="container-fluid d-md-none border-bottom mt-2">
        <div class="phone-nav">
            <a href="<?=RouteUri("news","all")?>" class="d-flex ms-2 me-3 text-danger justify-content-center align-items-center text-secondary bottom-border  min-width">
                All
            </a>
            <a href="<?=RouteUri("news","premierLeague")?>" class="d-flex me-3 justify-content-center align-items-center on-hover text-secondary min-width">
                Premier league
            </a>
        ...
        <div id="slides" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                        ...
                        <?php if($key == 1):?>
                            <a href="/news/<?=str_replace(' ','', $content['news_category'])?>/<?=urlencode($content['news_id'])?>" class="carousel-item active text-white">
                                <div class="row pe-3">
                                    ...
                                    <div class="col mt-5 mt-xl-0 pt-lg-5">
                ...
                <!-- <div class="carousel-item">
                    <div class="row pe-3">
                        <div class="col">
                            <img src="/view/images/cristiano-manu1.jpg" class="img-fluid">
                        </div>
                        <div class="col pt-lg-5">
                                <h3>Cristiano Ronaldo</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias soluta inventore architecto, ipsam cupiditate natus placeat sint commodi voluptatem dolorum minus provident, distinctio repellat suscipit perspiciatis officia in voluptas rem?</p>
                        </div>
                    </div>
                </div> -->
